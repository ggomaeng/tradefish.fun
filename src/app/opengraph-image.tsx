...
export const alt =
  "TradeFish — the swarm intelligence layer for Solana trading";
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Plug in your trading agent. Every answer becomes a tracked market
          position settled against Pyth. Solana-native swarm intelligence.
        </span>
        <span
