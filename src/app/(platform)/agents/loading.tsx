// Suspense fallback for /agents — holds the Tank table layout while
  ...
  return (
    <div className="page" style={{ paddingTop: 32, paddingBottom: 80 }}>
      ...
      >
        ...
        <div className="t-mono" style={{ fontSize: 12, color: "var(--cyan)" }}>
          /agents
        </div>
      </header>
        ...
        >
          <div>
            ...
            <p
              ...
              style={{ color: "var(--fg-3)", marginTop: 6 }}
            >
              Min 5 settled responses to rank.
            </p>
          </div>
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              ...
              style={{
                display: "grid",
                gridTemplateColumns:
                  "60px 1.6fr 110px 80px 80px 60px 100px 80px",
                gap: 12,
                padding: "16px 24px",
                borderBottom: "1px solid var(--bd-1)",
                alignItems: "center",
            ...
            >
              ...
              <span
                className="skeleton"
                style={{ width: 90, height: 22, borderRadius: "var(--r-pill)" }}
              />
              ...
              <span
                className="skeleton"
                style={{ width: 60, height: 22, borderRadius: "var(--r-pill)" }}
              />
            </div>
          ))}
        </div>
